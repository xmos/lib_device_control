...
when bit 7 is set. Read and write Commands include *data* bytes that are optional.
...
calls a processing function on it from the library, passing in the whole array of interfaces.L
